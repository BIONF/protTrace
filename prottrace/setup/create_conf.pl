...
sub userOptions {
	%prepOptions = (species => 'YEAST',
					  ...
					  REvolver => "$currwd/prottrace/traceability/REvolver.jar",
					simulation_tree => "$currwd/prottrace/traceability/stepwise_evolution.nw",
					decay_script => "$currwd/prottrace/traceability/r_nonlinear_leastsquare.R",
					plot_figtree => "$currwd/prottrace/traceability/plotPdf.jar",
	...
	%optionsValues = (species => 'OMA 5 letter Species Identifier: (Default HUMAN)',
					  ...
					  REvolver => "Path to REvolver (Default $currwd/prottrace/traceability/REvolver.jar)",
					simulation_tree => "Path to simulation tree (Default $currwd/prottrace/traceability/stepWiseTree.nw)",
					decay_script => "Path to decay script (Default $currwd/prottrace/traceability/r_nonlinear_leastsquare.)",
					plot_figtree => "Path to tree plotter (Default $currwd/prottrace/traceability/plotPdf.jar)",
